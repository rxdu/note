...
description: Notes on hardware systems
---
...
Notes on the jetson family (Jetson Nano/XavierNX/XavierAGX)):

* [Flash Jetson with Virtualbox](/tech-notes/system/jetson/flash-jetson-with-vm)
* [Flash Jetson with SDK Manager in Docker](/tech-notes/system/jetson/flash-jetson-with-docker)
* [Boot Jetson TX2/Nano from SD Card](/tech-notes/system/jetson/boot-jetson-tx2-from-microsd)

### Raspberry Pi

<!-- ![Raspberry Pi](./raspberrypi/figures/rpi4-resize.jpg) -->
Notes on the raspberry pi family (Raspberry Pi/Zero):
...
<!-- ![Beaglebone Black](./beaglebone/figures/bbb-resized.jpg) -->
Notes on the beaglebone family (Beaglebone Black/AI):
